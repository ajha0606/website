...
chiao <- country_profile_variables %>% mutate(region=Region, population_thousands=Population.in.thousands..2017., GDP=GDP..Gross.domestic.product..million.current.US.., unemployment.percent=Unemployment....of.labour.force., life.expect=Life.expectancy.at.birth..females.males..years.) %>% select(country, region, population_thousands, GDP, unemployment.percent, life.expect)
